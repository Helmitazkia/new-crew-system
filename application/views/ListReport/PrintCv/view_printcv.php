    ...
    <div class="card-body">
        ...
        <div class="row align-items-end">
            <div class="col-md-4">
                ...
                <select class="form-control selectpicker" data-live-search="true" data-size="5" data-style="btn-white border text-dark" name="id_company" id="selectCompany" required>
                    <!-- Options populated via JS -->
                </select>
            </div>
            <div class="col-md-2">
                <button type="button" class="btn btn-primary btn-sm w-100" id="btnPrintCv" style="background-color: #000999; border-color: #000999; height: 34px;">
