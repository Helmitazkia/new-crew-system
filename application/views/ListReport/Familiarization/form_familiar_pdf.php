...
<body>
    ...
    <div style="margin-bottom: 20px;">
        ...
        3. Tick <?php echo famMark("1"); ?> for things that are done and the sign <?php echo famMark("2"); ?> for
    ...
    <table class="table-border" style="margin-bottom: 20px;">
        <thead>
            <tr>
                ...
                <th style="width: 10%; text-align:center;"><?php echo famMark("1"); ?> / <?php echo famMark("2"); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php if (!empty($topics)): ?>
                ...
                <tr>
                    ...
                    <td style="text-align:center; font-size:14px; font-family:'DejaVu Sans',sans-serif;">
                        <?php 
                            $prop = 'item_' . $topic->id;
                            echo famMark(isset($history->$prop) ? $history->$prop : null); 
                        ?>
                    </td>
                </tr>
                <?php endforeach; ?>
