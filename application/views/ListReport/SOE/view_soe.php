  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content border-0 shadow">
      ...
      <div class="modal-footer bg-light" style="justify-content:flex-end;">
          ...
          <button type="button" class="btn btn-sm btn-primary px-4" id="btnSaveAndPrintStatementCrew">Simpan & Print PDF</button>
          <button type="button" class="btn btn-sm btn-primary px-4 d-none" id="btnGeneratePdfFromModalSoe"><i class="fa fa-print me-1"></i> Print PDF</button>
      </div>
