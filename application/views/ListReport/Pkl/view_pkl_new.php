...
<div class="card shadow-sm border-0" id="pklModuleWrapper">
    <div class="card-body">
        <div class="d-flex justify-content-end mb-3">
            <button class="btn btn-primary btn-sm rounded shadow-sm" id="btnAddPKL" style="background-color: #000999; border-color: #000999;">
  ...
  <div class="modal-dialog modal-xl" style="max-width: 85%;" role="document">
    <div class="modal-content border-0 shadow">
      ...
      <div class="modal-header" style="background: linear-gradient(135deg, #000999 0%, #1a237e 100%); color: #fff;">
        ...
        <button type="button" class="btn-close btn-close-white close" data-dismiss="modal" aria-label="Close" style="filter: invert(1) grayscale(100%) brightness(200%); border:none; background:transparent; font-size:24px; color:#fff;">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-4">
              <div class="card h-100 border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                  <h6 class="text-primary fw-bold mb-0"><i class="fa fa-user me-2"></i>Personal Information</h6>
                </div>
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Date of Birth / Tgl Lahir <span class="text-danger">*</span></label>
                      <input type="date" id="txtDoBInput" name="dob" class="form-control mandatory">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                  ...
                  <div class="form-group mb-3">
                    <label class="form-label fw-semibold">Seafarer Code / Kode Pelaut <span class="text-danger">*</span></label>
                    <input type="text" id="txtSeafarerCodeInput" name="kodepelaut" class="form-control mandatory">
                  </div>

                  <div class="form-group mb-3">
                    <label class="form-label fw-semibold">Home Address / Alamat Rumah <span class="text-danger">*</span></label>
                    <textarea id="txtAddressInput" name="paddress" class="form-control mandatory" rows="2"></textarea>
                  </div>

                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Passport No / No. Paspor <span class="text-danger">*</span></label>
                      <input type="text" id="txtPassportNoInput" name="passportno" class="form-control mandatory">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Seaman Book No / No. Buku Pelaut <span class="text-danger">*</span></label>
                      <input type="text" id="txtSeamanBookNoInput" name="seamanbookno" class="form-control mandatory">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 mb-4">
              <div class="card border-0 shadow-sm mb-3">
                <div class="card-header bg-white py-3">
                  <h6 class="text-primary fw-bold mb-0"><i class="fa fa-ship me-2"></i>Vessel Assignment</h6>
                </div>
                <div class="card-body">
                  <div class="form-group mb-3">
                    <label class="form-label fw-semibold">Select Vessel / Pilih Kapal <span class="text-danger">*</span></label>
                    <select id="txtVesselFor" name="txtVesselFor" class="form-control form-select mandatory">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                      ...
                      <input type="text" id="txtVesselName" class="form-control bg-light" readonly>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Company / Perusahaan</label>
                      <input type="text" id="txtCompanyNameInput" class="form-control bg-light" readonly>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                      ...
                      <input type="text" id="txtCompetencyCert" name="txtCompetencyCert" class="form-control">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Safety Cert. / SERKES</label>
                      <input type="text" id="txtSafetyCert" name="txtSafetyCert" class="form-control">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                  <h6 class="text-primary fw-bold mb-0"><i class="fa fa-money me-2"></i>Duration & Wages</h6>
                </div>
                <div class="card-body">
                  <div class="form-group mb-3">
                    <label class="form-label fw-semibold">Duration / Jangka Waktu (Months / Bulan) <span class="text-danger">*</span></label>
                    <input type="number" id="txtDuration" name="txtduration" class="form-control mandatory" min="1" max="12" placeholder="e.g. 12">
                  </div>

                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Basic Wage (Rp) <span class="text-danger">*</span></label>
                      <input type="text" id="txtBasicWage" name="txtBasicWage" class="form-control mandatory text-end" value="0">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Fix Overtime (Rp) <span class="text-danger">*</span></label>
                      <input type="text" id="txtFixOvertime" name="txtFixOvertime" class="form-control mandatory text-end" value="0">
                    </div>
                  </div>

                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Leave Pay (Rp) <span class="text-danger">*</span></label>
                      <input type="text" id="txtLeavePay" name="txtLeavePay" class="form-control mandatory text-end" value="0">
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <label class="form-label fw-semibold">Tanker Allowance (Rp) <span class="text-danger">*</span></label>
                      <input type="text" id="txtTankerAllowance" name="txtTankerAllowance" class="form-control mandatory text-end" value="0">
                    </div>
                  </div>

                  <div class="p-3 bg-light rounded d-flex justify-content-between align-items-center mt-2 border">
      ...
      <div class="modal-footer bg-light py-3" style="justify-content: flex-end;">
        ...
        <button type="button" class="btn btn-primary btn-sm px-4" id="btnSaveAndPrint"><i class="fa fa-save me-1"></i> Save & Print</button>
        <button type="button" class="btn btn-success btn-sm px-4 d-none" id="btnPrintFromModal"><i class="fa fa-print me-1"></i> Print</button>
      </div>
    </div>
  </div>
</div>
...
.dataTables_length label, .dataTables_filter label { display: flex; align-items: center; margin: 0; padding: 10px 0; }
...
$(document).ready(function() {
    ...
    var pklTable = $('#pklTable').DataTable({
        ...
        columns: [
            ...
            { 
                data: 'total_wage', className: 'text-center',
                render: function(data) { return 'Rp ' + formatNumber(data); }
            },
            { 
                data: 'duration_months', className: 'text-center',
                render: function(data) { return data + ' bulan'; }
            },
            { data: 'created_at_fmt', className: 'text-center fw-bold' },
            {
                data: null, className: 'text-center', orderable: false, searchable: false,
                render: function(data) {
                    return '<div class="btn-group btn-group-sm" role="group">' +
                        '<button type="button" class="btn btn-outline-primary btn-view-pkl" title="View Detail" data-id="' + data.id_history_wages + '">' +
                            '<i class="fa fa-eye"></i>' +
                        '</button>' +
                        '<button type="button" class="btn btn-outline-warning btn-print-pkl" title="Print PDF" data-id="' + data.id_history_wages + '">' +
                            '<i class="fa fa-print"></i>' +
                        '</button>' +
                        '<button type="button" class="btn btn-outline-danger btn-delete-pkl" title="Delete" data-id="' + data.id_history_wages + '">' +
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.success) {
                    ...
                    $('#txtVesselFor').val(d.vessel_name); // Wait! Vessel selection can't match code if it's name. So let's handle setting dropdown
                    ...
                    $('#txtBasicWage').val(formatValueWithDots(Math.round(d.basic_wage)));
                    $('#txtFixOvertime').val(formatValueWithDots(Math.round(d.fix_overtime)));
                    $('#txtLeavePay').val(formatValueWithDots(Math.round(d.leave_pay)));
                    $('#txtTankerAllowance').val(formatValueWithDots(Math.round(d.tanker_allowance)));
    ...
    $('#btnSaveAndPrint').on('click', function() {
        ...
        // Validate Duration max 12
        let duration = parseInt($('#txtDuration').val()) || 0;
        if (duration > 12) {
            $('#txtDuration').addClass('is-invalid');
            notifyUser('warning', 'Duration / Jangka Waktu tidak boleh lebih dari 12 bulan.');
            $('#txtDuration').focus();
            return;
        }
    ...
    function notifyUser(type, msg) {
        if (typeof Swal !== 'undefined') {
            Swal.fire({
                icon: type,
                title: type === 'success' ? 'Sukses' : (type === 'warning' ? 'Peringatan' : 'Error'),
                text: msg,
                timer: 3000,
