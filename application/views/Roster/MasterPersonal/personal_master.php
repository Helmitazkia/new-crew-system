          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="crewTable" class="table table-bordered align-middle mb-0 crew-table" style="width:100%">
                ...
                <thead>
                  <tr>
                    <th><input type="text" class="column-search" placeholder="Search No"></th>
                    ...
                    <!-- <th><input type="text" class="column-search" placeholder="Search Action" disabled></th> -->
                  </tr>
                </thead>
...
$(document).ready(function() {
  ...
  //         let start = (json.page - 1) * json.limit + 1;

  //         // Tambahkan nomor urut dan action ke setiap data
  //         json.data.forEach(function (item, index) {
  //           item.no = start + index;
  //           // item.action = '<button class="btn btn-sm btn-primary btn-edit" data-id="' + item.idperson +
  //           //   '">Edit</button>' +
  //           //   '<button class="btn btn-sm btn-danger btn-delete" data-id="' + item.idperson +
  //           //   '">Delete</button>';
  //         });
  //         return json.data;
  //       } else {
  ...
  //         // return `<a href="#" class="crew-name" onclick="showCrewDetail('${row.idperson}')">${data}</a>`;
  //       }
  //     },
  //     {
  //       data: 'applyfor',
  ...
  //       className: 'text-center',
  //       render: function (data) {
  //         let badgeClass = data === 'Yes' ? 'bg-success' : 'bg-secondary';
  //         return `<span class="badge ${badgeClass}">${data}</span>`;
  //       }
  //     },
  //     {
  ...
  //       // Skip search untuk kolom No dan Action
  //       if (column.index() === 0 || column.index() === 8) return;
    ...
    columns: [{
      ...
      },
      {
        ...
        render: (data, type, row) =>
          `<a href="#" onclick="showCrewDetail('${row.idperson}')">${data}</a>`
      },
      {
        data: 'applyfor',
        className: 'text-center'
      ...
      },
      {
        ...
        className: 'text-center',
        render: d =>
          `<span class="badge ${d === 'Yes' ? 'bg-warning' : 'bg-secondary'}">${d}</span>`
      },
      {
        data: null,
        orderable: false,
  ...
  //   let id = $(this).data('id');
  //   console.log('Edit crew ID:', id);
  //   // Implementasi edit
  // });

  // $(document).on('click', '.btn-delete', function () {
  //     let id = $(this).data('id');
  //     console.log('Delete crew ID:', id ');
  //       if (confirm('Are you sure want to delete this crew?')) {
  //         // Implementasi delete dengan AJAX
  //       }
  //     });
  ...
  // $(document).on('click', '.btn-delete', function() {
  //     let id = $(this).data('id');
  //     console.log('Delete crew ID:', id); // INI YANG DIPERBAIKI
  //     if (confirm('Are you sure want to delete this crew?')) {
  //         // Implementasi delete dengan AJAX
  //     }
  // });
