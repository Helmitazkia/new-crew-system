...
function renderCertificateTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var matrixIcon = (data[i].show_matrix === 'Y') ?
            '<i class="fa fa-check text-success"></i>' :
            '<i class="fa fa-close text-danger"></i>';
        ...
        html += ' <td class="text-center">' + matrixIcon + '</td>';
...
function saveData() {
    ...
    var slcShowMatrix = $("#slcShowMatrix").val();
    ...
    formData.append('slcShowMatrix', slcShowMatrix);
...
function getDataEdit(id, type) {
    ...
    $.post('<?php echo base_url("certificate/get-edit"); ?>', {
        ...
        function(data) {
            ...
            $("#slcShowMatrix").val(data['rsl'][0]['show_matrix']);
    ...
    <div class="col-md-4 col-xs-12">
        ...
        ">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12" style="margin-bottom:10px;">
                    <label style="font-size:12px;">Show Matrix</label>
                    <select class="form-control input-sm" id="slcShowMatrix" style="border-radius:6px;">
                        <option value="Y">Y</option>
                        <option value="N">N</option>
                    </select>
                </div>
