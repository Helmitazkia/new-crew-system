...
class McuReport extends CI_Controller {
    ...
    {
        $data['title'] = 'MCU Report';
        $data['active_menu'] = 'mcu_report';
        $this->load->view('layout/header', $data);
        $this->load->view('Report/McuReport/view_mcu_report');
    ...
    public function submit_report_mcu()
    {
        ...
        foreach ($crewList as $crew) {
            ...
            $idPerson = isset($crew['id_person']) ? $crew['id_person'] : NULL;
    ...
    public function generatePDF_MCU()
    {
        ...
        $html = $this->load->view('Report/McuReport/pdf_mcu_report', $data, TRUE);
        $mpdf->WriteHTML($html);
